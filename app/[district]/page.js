        ...
        <div className="grid gap-4 md:gap-6 md:grid-cols-4">
          <div className=" md:col-span-3">
            <h1 className="mb-3 text-lg font-bold mt:mb-6 md:text-2xl">
              Latest Jobs in {jobsData.jobs.metadata[0].district.name}
            </h1>
            <DistrictFilter />
            <div className="cards">
